...
public class main {
    ...
    public static void main(String[] args) {
        ...
        // All points sum'd up
        int totalPoints = MATH_EC + FASTEN_YOUR_SEATBELTS_EC + PROGRAMMING_EC + PERSONAL_SKILLS_EC
                + USER_INTERACTION_EC;
        ...
        double fraction = (double) 5 / (double) 6 * totalPoints;
        int fractionConverted = (int) fraction;

        // Display results
        System.out.println("Vak/Project: " + MATH + " Cijfer: " + myMathGrade + " Behaalde punten: " + mathPoints);
        System.out.println("Vak/Project: " + FASTEN_YOUR_SEATBELTS + " Cijfer: " + myFastenYourSeatbeltsGrade
                + " Behaalde punten: " + fysPoints);
        System.out.println("Vak/Project: " + PROGRAMMING + " Cijfer: " + myProgrammingGrade + " Behaalde punten: "
                + programmingPoints);
        System.out.println("Vak/Project: " + PERSONAL_SKILLS + " Cijfer: " + myPersonalSkillsGrade
                + " Behaalde punten: " + personalSkillsPoints);
        System.out.println("Vak/Project: " + USER_INTERACTION + " Cijfer: " + myUserInteractionGrade
                + " Behaalde punten: " + userInteractionPoints);
